...
const useStyles = makeStyles((theme) => ({
  ...
  paper: {
    ...
    boxShadow: "0 5px 10px rgba(48,58,83,.025), 0 15px 40px rgba(48,58,83,.5) !important",
...
export default function CookieNotification() {
  ...
  return (
    <>
    {rootState.authStatusChecked && !state.consent && <Box
      ...
      <Paper className={classes.paper}>
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} sm={4}>
            <Button variant="contained" color="primary" fullWidth disableElevation size="small" onClick={handleConsent}>
              Am înțeles
            </Button> 
          </Grid>
        </Grid>
