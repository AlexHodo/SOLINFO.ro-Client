  ...
  return (
    <>
      ...
      {state.dataLoaded && state.success && (
        <div>
          <MetaTags>
            <title>Pagina administratorilor | SOLINFO.ro</title>
          </MetaTags>
                    ...
                    return (
                      <Grid container className={classes.row}>
                        <Grid item xs={12} md={3} component={Box} mb={1}>
                          #
                          <a
                            href={`https://www.pbinfo.ro/probleme/${solution.pid}`}
                            target="_blank"
                          >
                            <b>
                              {solution.pid} {solution.name}
                            </b>
                          </a>
                          <br />
                          ID soluție: #{solution.sid}
                          {solution.from_extension && (
                            <>
                              <br />
                              Prin extensie.
                            </>
                          )}
                          {solution.from_import && (
                            <>
                              <br />
                              Prin import.
                            </>
                        ...
                        <Grid item xs={12} md={3} component={Box} mb={1}>
                          @
                          <a
                            href={`https://solinfo.ro/profil/${solution.username}`}
                            target="_blank"
                          >
                            <b>{solution.username}</b>
                          </a>
                          {solution.already_solved && (
                            <>
                              <br />A rezolvat deja problema.
                            </>
                          )}
                          {solution.is_weekly_challenge && (
                            <>
                              <br />
                              Provocare săptămânală.
                            </>
                          )}
                          {solution.solved_in_weekly_challenge && (
                            <>
                              <br />A rezolvat deja provocarea.
                            </>
                          )}
                        </Grid>
                        <Grid item xs={12} md={6} component={Box} mb={0}>
                          <Grid container component={Box} mb={1}>
                            <Grid item xs={6}>
                              <LanguageTag
                                language={
                                  solution.language ? solution.language : null
                                }
